...
public class ParkFrame extends JFrame {
	...
	//input에서 아마 버그나는 차고번호를 집어넣게 했을거임 그럼 버그안날거라 생각했고 실제로 고쳐짐
	//Output에서는 배열을 삭제하면 어레이아웃오브인덱스 예외가뜰거고 분명히 왜냐? 지금 배열의크기는 차고에 맞게 이닛
	//컴포넌트에서 설정해놨음 set 인덱스번호로 들어가서 값을 ""을 주면됨 (널은 절대 안됨)
	//남은게 추측해보자면
